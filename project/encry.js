...
function _gas(data,key0,iv0){
    ...
    var key  = CryptoJS.enc.Utf8.parse(key0);var iv   = CryptoJS.enc.Utf8.parse(iv0);
...
/*console.log(_etd2("zxd960211","Vxj1sStmbVT5tfDQ"))*/
...
axios(config)
    .then(function (response) {
        ...
        console.log($('#pwdDefaultEncryptSalt').val());
    })
